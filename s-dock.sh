...
sudo docker run -d -it -p 25565:25565 -e EULA=TRUE -e MEMORY=2G -e MAX_TICK_TIME=-1 -e ENABLE_AUTOPAUSE=TRUE -v /home/jesjack/Proyectos/minecraft/doc-serv-1:/data --name mc itzg/minecraft-server
